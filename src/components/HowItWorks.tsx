...
export default function HowItWorks() {
  ...
  return (
    <div className="bg-orange-50 py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto">
        {/* Title */}
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-orange-500 mb-8 sm:mb-12 md:mb-16 animate-slide-down">
          How does it work
        </h2>
